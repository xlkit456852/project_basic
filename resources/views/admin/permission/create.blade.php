    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form action="{{url('manage/permission')}}" id="edit_form" class="form-horizontal" method="post" role="form" novalidate>
                        {{csrf_field()}}
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">权限名称 <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control" id="name" name="name" required value="{!! old('name') !!}" placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control" id="slug" name="slug" required value="{!! old('slug') !!}" placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="parent_id">
                                    ...
                                    @foreach($p_permissions as $p)
                                        <option value="{{$p->id}}" @if(old('parent_id')==$p->id)selected @endif >{{$p->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control" id="model" name="model" value="{!! old('model') !!}" placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control" id="icon" name="icon" value="{!! old('icon') !!}" placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control" id="sort_order" name="sort_order" value="{!! old('sort_order') !!}" placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <label>
                                        <input type="radio" class="flat" name="is_admin" value="1" @if(old('is_admin')==1) checked @endif > 是
                                    </label>
                                    <label>
                                        <input type="radio" class="flat" name="is_admin" value="0" @if(old('is_admin')==0) checked @endif> 否
                                    </label>
                                </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <label>
                                        <input type="radio" class="flat" name="is_show" value="1" @if(old('is_show')==1) checked @endif > 是
                                    </label>
                                    <label>
                                        <input type="radio" class="flat" name="is_show" value="0" @if(old('is_show')==0) checked @endif> 否
                                    </label>
                                </div>
